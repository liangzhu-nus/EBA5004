...
BATCH_SIZE = 8
# 参数2:训练数据文件路径
train_data_file_path = f"{CURRENT_DIR}/data/train.npz"
...
# 参数6:训练文件存放路径
model_saved_path = f"{CURRENT_DIR}/model/bilstm_crf_state_dict_{time_str}.pt"
# 参数7:训练日志文件存放路径
train_log_path = f"{CURRENT_DIR}/log/train_{time_str}.log"
# 参数8:验证打印日志存放路径
validate_log_path = f"{CURRENT_DIR}/log/validate_{time_str}.log"
# 参数9:训练历史记录图存放路径
train_history_image_path = f"{CURRENT_DIR}/log/bilstm_crf_train_plot_{time_str}.png"
# 参数10:字向量维度
EMBEDDING_DIM = 200
# 参数11:隐层维度
HIDDEN_DIM = 100
