...
# tokenizer = torch.hub.load('huggingface/pytorch-transformers', 'tokenizer', 'bert-base-chinese', force_reload=True)
# # 使用torch.hub加载bert中文模型
# model = torch.hub.load('huggingface/pytorch-transformers', 'model', 'bert-base-chinese', force_reload=True)
